	...
	<body class="body_accueil">
		<div class="bloc_accueil">
			...
			<div class="bloc_photo">
				<img class="photo_accueil" src="Images/sport.jpg" alt="photo de sports multiples" />
				...
				<div class="paragraphe_bouton">
					...
					<a href="page_enregistrement_sportif.php" class="nav_button">Rejoindre le programme</a>
				</div>
			</div>
	</body>
</html>